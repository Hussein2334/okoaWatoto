        ...
        if ($stmt->execute($params)) {
            ...
            if (function_exists('logActivity')) {
                logActivity(
                    "Case Updated",
                    "update",
                    "Staff {$_SESSION['user_name']} updated case {$case['case_number']}",
                    $case,
...
<div class="mb-4">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
        ...
        <a href="cases.php" class="bg-gray-500 text-white px-3 py-1.5 rounded-lg text-sm hover:bg-gray-600 transition-colors flex items-center gap-1">
...
<div class="bg-white rounded-lg border border-gray-200 shadow-sm">
    ...
    <form method="POST" enctype="multipart/form-data" class="p-4 space-y-4">
        ...
        <div class="flex gap-3 pt-3">
            ...
            <a href="cases.php" class="bg-gray-200 text-gray-700 px-4 py-1.5 rounded-lg text-sm hover:bg-gray-300 transition-colors">
                Cancel
            </a>
        </div>
    </form>
...
<div class="bg-white rounded-lg border border-gray-200 shadow-sm">
    <?php if($case_type == 'missing'): ?>
    <!-- Edit Missing Case Form (Same as Admin) -->
    <form method="POST" enctype="multipart/form-data" class="p-4 space-y-4">
        <!-- Child Information -->
        <div class="border-b border-gray-200 pb-3">
            <h2 class="text-sm font-bold text-primary mb-3 flex items-center gap-2">
    ...
    <?php else: ?>
    <!-- Edit Found Case Form (Same as Admin) -->
    <form method="POST" enctype="multipart/form-data" class="p-4 space-y-4">
        <div class="border-b border-gray-200 pb-3">
            <h2 class="text-sm font-bold text-primary mb-3 flex items-center gap-2">
                <span class="material-symbols-outlined text-base">child_care</span>
