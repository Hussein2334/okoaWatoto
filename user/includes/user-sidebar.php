    ...
    <aside id="sidebar" class="fixed md:relative z-40 bg-white border-r border-gray-200 transition-transform duration-300 transform -translate-x-full md:translate-x-0 shadow-lg flex flex-col h-full" style="width: 220px; min-width: 220px; max-width: 220px;">
        ...
        <div class="flex-1 overflow-y-auto p-2">
            <nav class="space-y-0.5">
                ...
                <!-- My Reports -->
                <a href="my-reports.php" class="flex items-center gap-2 px-2 py-2 rounded-lg transition-all duration-200 <?php echo $current_page == 'my-reports.php' ? 'bg-primary text-white shadow-md' : 'text-gray-700 hover:bg-gray-100'; ?>">
                ...
                <div class="border-t border-gray-200 my-2 pt-2">
                    <a href="../index.php" class="flex items-center gap-2 px-2 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition-all duration-200">
            ...
            <div class="p-2">
                <div class="p-2 rounded-lg bg-gray-50">
                    ...
                    <div class="mt-1 pt-1 border-t border-gray-200 text-xs text-gray-400">
                        <div><span class="font-medium">User:</span> <?php echo $_SESSION['user_name'] ?? 'User'; ?></div>
                        <div><span class="font-medium">Role:</span> <?php echo ucfirst($_SESSION['user_role'] ?? 'User'); ?></div>
                    </div>
                </div>
            </div>
        </div>
